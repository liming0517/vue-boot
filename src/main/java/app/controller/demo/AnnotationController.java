...
@Controller
public class AnnotationController extends CrudController<Student, Student1Service> {
	...
	public @ResponseBody GridResult listPage(@RequestBody SearchStudentEntity searchStudentEntity) {
	...
	public  @ResponseBody GridResult listAnnoGender(@RequestBody SearchStudentEntity searchStudentEntity) {
