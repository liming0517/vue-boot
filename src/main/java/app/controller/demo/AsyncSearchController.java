...
// 异步调用
@Controller
public class AsyncSearchController extends SearchController<Student, Student1Service> {

	// 同步
	@RequestMapping("/listSync_backuser.do")
	public @ResponseBody GridResult listSync_backuser(@RequestBody SearchStudentEntity searchStudentEntity) {
