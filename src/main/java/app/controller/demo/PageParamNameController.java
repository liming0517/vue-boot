...
@Controller
public class PageParamNameController extends SearchController<Student, Student1Service> {
	...
	public @ResponseBody GridResult pageParamNameList(@RequestBody SearchStudentEntity searchStudentEntity) {
