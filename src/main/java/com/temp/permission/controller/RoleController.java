...
public class RoleController {
    ...
    @ApiOperation(value = "用户和角色信息列表", notes = "查询用户信息和可管理的角色")
    @RequestMapping(value = "/listBytoken", method = { RequestMethod.POST })
    public ResponseData listByToken() {
    	 String t=(String) session.getAttribute("token");
    	 Map<String, Object> map = new HashMap<>();
         map.put("Rolelist", service.getListByToken());
         map.put("User", umapper.queryOne1(t));
