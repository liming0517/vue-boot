...
public class wcheckService {
    ...
    public Integer save(wcheck note2) {
        ...
        if (note2.getId() != null) {
        	System.out.println("有ID修改时候getid==="+note.getId()+"|||getUsername==="+note.getUsername()+"||"+note.getUsercode()+"||"+note.getStime()+"||"+note.getEtime()+"||"+note.getOutdesc()+"||"+note.getTime());
	...
	public JSONArray batchImport(String fileName, MultipartFile file) throws Exception {
       ...
       /* if (fileName.matches("^.+\\.(?i)(xlsx)$")) {
    	...
    	boolean test=isRigthCoulm(a1,a2,a3,a4,a5,a6);
    	if(test) {
...
//                }
                ...
                System.out.println("第"+r+"行:"+a+","+b+","+c+","+d+","+e+","+f+".....");
                //完整的循环一次 就组成了一个对象
                note.setId(null);
                note.setTime(a);
                note.setUsercode(b);
    ...
    public static boolean isRigthCoulm(String a1,String b1,String c1,String d1,String e1,String f1)  {
        if(aa.equals(a1)&&bb.equals(b1)&&cc.equals(c1)&&dd.equals(d1)&&ee.equals(e1)&&ff.equals(f1)) {
        	return true;
        }
        else {
