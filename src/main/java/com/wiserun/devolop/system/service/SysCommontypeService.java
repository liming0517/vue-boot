...
import com.wiserun.devolop.system.dao.SysCommontypeDao;
import com.wiserun.devolop.system.entity.SysCommontype;
import com.wiserun.devolop.system.entity.SysCommontypeSch;
import com.wiserun.devolop.system.service.SysCommontypeService;//用于读取代码表数据
...
@Service
public class SysCommontypeService extends CrudService<SysCommontype, SysCommontypeDao> {
	
	@Autowired
	SysCommontypeService SysCommontypeservice;
	 ...
	 * 无业务需求则可不做任何处理 
	 */
	public void setInfoByID(SysCommontype entity) {
		
		 //根据实际需要扩展--如前台已传入相应数据，这里也可以不做任何处理，以提高执行效率
		SysCommontype sysCommontype;
		if(null!=entity.getId()){
			sysCommontype=SysCommontypeservice.get(entity.getId());
			
			if (null!=sysCommontype){
	           //entity.setProjectTypeCode(sysCommontype.getDetailCode()); //项目代码
	           //entity.setProjectTypeName(sysCommontype.getCodeName()); //项目名称
			}
		}
	 ...
	 * 无业务需求则可不做任何处理 
	 */
	public void setInfoByName(SysCommontype entity) {
	 ...
	 * @param entity
	 */
	public ExpressionQuery queryNoLimitBefore(SysCommontypeSch entity){
	 ...
	 * @param entity
	 */
	public ExpressionQuery queryBefore(SysCommontypeSch entity){
		ExpressionQuery query = new ExpressionQuery();
		query=this.buildExpressionQuery(entity);
	 ...
	 */
	public MessageResult insertCheck(SysCommontype entity){
	 ...
	 * @return MessageResult 如 MessageResult.isError 则表示判断失败
	 */
	public MessageResult updateCheck(SysCommontype entity){
	 ...
	 * @return MessageResult 如 MessageResult.isError 则表示判断失败
	 */
	public MessageResult delCheck(SysCommontype entity){
		DefaultMessageResult mes; //消息对象
	 ...
	 * @return MessageResult 如 MessageResult.isError 则表示判断失败
	 */
	public MessageResult lgdelCheck(SysCommontype entity){
	 ...
	 * @param entity
	 */
	public void insertOrUpdateBefore(SysCommontype entity){
	 ...
	 * @param entity
	 */
	public void lgdelBefore(SysCommontype entity){
	 ...
	 * @param entity
	 */
	public void delBefore(SysCommontype entity){
	 ...
	 */
	public void insertOrUpdateBatchBefore(List<SysCommontype> EntiyList){
	 ...
	 */
	public void lgdelBatchBefore(List<SysCommontype> EntiyList){
		if (null==EntiyList) return ; //为空则跳出
	 ...
	 */
	public void delBatchBefore(List<SysCommontype> EntiyList){
		if (null==EntiyList) return ; //为空则跳出
	 ...
	 * @param entity
	 */
	public void insertOrUpdateAfter(SysCommontype entity){
	 ...
	 * @param entity
	 */
	public void lgdelAfter(SysCommontype entity){
		if (null==entity) return ; //为空则跳出
	 ...
	 * @param entity
	 */
	public void delAfter(SysCommontype entity){
		if (null==entity) return ; //为空则跳出
	 ...
	 * @param List<Entity> --批量（新增或更新）对象
	 */
	public void insertOrUpdateBatchAfter(List<SysCommontype> EntiyList){
	 ...
	 * @param List<Entity> --批量（逻辑删除）对象
	 */
	public void lgdelBatchAfter(List<SysCommontype> EntiyList){
	 ...
	 * @param List<Entity> --批量（物理删除）对象
	 */
	public void delBatchAfter(List<SysCommontype> EntiyList){
	...
	public MessageResult batchByCheckSysCommontype(Map<String, Object> map) throws RuntimeException {
		...
		////////////主表对象-map.get 获取的form名需要与前台保持一致//////////////
		 ...
		 SysCommontypeSch entity=JSON.parseObject((String)(map.get("schForm")), SysCommontypeSch.class); //form名称：schForm 由前台页面指定
		 ...
		 */
		 ...
		 ////////////明细表格对象 dg//////////////
	   	 ...
	   	 List<SysCommontype> entityInserted=JSON.parseArray((String)jsondg.get("inserted"), SysCommontype.class);
	   	 List<SysCommontype> entityUpdated=JSON.parseArray((String)jsondg.get("updated"), SysCommontype.class);
	 	 List<SysCommontype> entitylgDeleted=JSON.parseArray((String)jsondg.get("deleted"), SysCommontype.class);
