...
import com.wiserun.devolop.system.dao.SysAreaDao;
import com.wiserun.devolop.system.entity.SysArea;
import com.wiserun.devolop.system.entity.SysAreaSch;
import com.wiserun.devolop.system.service.SysAreaService;//用于读取代码表数据
...
@Service
public class SysAreaService extends CrudService<SysArea, SysAreaDao> {
	 ...
	 * 无业务需求则可不做任何处理 
	 */
	public void setInfoByID(SysArea entity) {
		
		 //根据实际需要扩展--如前台已传入相应数据，这里也可以不做任何处理，以提高执行效率
		SysArea sysArea;
		if(null!=entity.getId()){
			sysArea=SysAreaservice.get(entity.getId());
			
			if (null!=sysArea){
	           //entity.setProjectTypeCode(sysArea.getDetailCode()); //项目代码
	           //entity.setProjectTypeName(sysArea.getCodeName()); //项目名称
			}
		}
	 ...
	 * 无业务需求则可不做任何处理 
	 */
	public void setInfoByName(SysArea entity) {
	 ...
	 * @param entity
	 */
	public ExpressionQuery queryNoLimitBefore(SysAreaSch entity){
	 ...
	 * @param entity
	 */
	public ExpressionQuery queryBefore(SysAreaSch entity){
		ExpressionQuery query = new ExpressionQuery();
		query=this.buildExpressionQuery(entity);
	 ...
	 */
	public MessageResult insertCheck(SysArea entity){
	 ...
	 * @return MessageResult 如 MessageResult.isError 则表示判断失败
	 */
	public MessageResult updateCheck(SysArea entity){
	 ...
	 * @return MessageResult 如 MessageResult.isError 则表示判断失败
	 */
	public MessageResult delCheck(SysArea entity){
		DefaultMessageResult mes; //消息对象
	 ...
	 * @return MessageResult 如 MessageResult.isError 则表示判断失败
	 */
	public MessageResult lgdelCheck(SysArea entity){
	 ...
	 * @param entity
	 */
	public void insertOrUpdateBefore(SysArea entity){
	 ...
	 * @param entity
	 */
	public void lgdelBefore(SysArea entity){
	 ...
	 * @param entity
	 */
	public void delBefore(SysArea entity){
	 ...
	 */
	public void insertOrUpdateBatchBefore(List<SysArea> EntiyList){
	 ...
	 */
	public void lgdelBatchBefore(List<SysArea> EntiyList){
		if (null==EntiyList) return ; //为空则跳出
	 ...
	 */
	public void delBatchBefore(List<SysArea> EntiyList){
		if (null==EntiyList) return ; //为空则跳出
	 ...
	 * @param entity
	 */
	public void insertOrUpdateAfter(SysArea entity){
	 ...
	 * @param entity
	 */
	public void lgdelAfter(SysArea entity){
		if (null==entity) return ; //为空则跳出
	 ...
	 * @param entity
	 */
	public void delAfter(SysArea entity){
		if (null==entity) return ; //为空则跳出
	 ...
	 * @param List<Entity> --批量（新增或更新）对象
	 */
	public void insertOrUpdateBatchAfter(List<SysArea> EntiyList){
	 ...
	 * @param List<Entity> --批量（逻辑删除）对象
	 */
	public void lgdelBatchAfter(List<SysArea> EntiyList){
	 ...
	 * @param List<Entity> --批量（物理删除）对象
	 */
	public void delBatchAfter(List<SysArea> EntiyList){
	...
	public MessageResult batchByCheckSysArea(Map<String, Object> map) throws RuntimeException {
		...
		////////////主表对象-map.get 获取的form名需要与前台保持一致//////////////
		 ...
		 SysAreaSch entity=JSON.parseObject((String)(map.get("schForm")), SysAreaSch.class); //form名称：schForm 由前台页面指定
		 ...
		 */
		 ...
		 ////////////明细表格对象 dg//////////////
	   	 ...
	   	 List<SysArea> entityInserted=JSON.parseArray((String)jsondg.get("inserted"), SysArea.class);
	   	 List<SysArea> entityUpdated=JSON.parseArray((String)jsondg.get("updated"), SysArea.class);
	 	 List<SysArea> entitylgDeleted=JSON.parseArray((String)jsondg.get("deleted"), SysArea.class);
