...
import com.wiserun.devolop.system.dao.SysRolePermissionDao;
import com.wiserun.devolop.system.entity.SysRolePermission;
import com.wiserun.devolop.system.entity.SysRolePermissionSch;
import com.wiserun.devolop.system.service.SysRolePermissionService;//用于读取代码表数据
...
@Service
public class SysRolePermissionService extends CrudService<SysRolePermission, SysRolePermissionDao> {
	 ...
	 * 无业务需求则可不做任何处理 
	 */
	public void setInfoByID(SysRolePermission entity) {
		
		 //根据实际需要扩展--如前台已传入相应数据，这里也可以不做任何处理，以提高执行效率
		SysRolePermission sysRolePermission;
		if(null!=entity.getId()){
			sysRolePermission=SysRolePermissionservice.get(entity.getId());
			
			if (null!=sysRolePermission){
	           //entity.setProjectTypeCode(sysRolePermission.getDetailCode()); //项目代码
	           //entity.setProjectTypeName(sysRolePermission.getCodeName()); //项目名称
			}
		}
	 ...
	 * 无业务需求则可不做任何处理 
	 */
	public void setInfoByName(SysRolePermission entity) {
	 ...
	 * @param entity
	 */
	public ExpressionQuery queryNoLimitBefore(SysRolePermissionSch entity){
	 ...
	 * @param entity
	 */
	public ExpressionQuery queryBefore(SysRolePermissionSch entity){
		ExpressionQuery query = new ExpressionQuery();
		query=this.buildExpressionQuery(entity);
	 ...
	 */
	public MessageResult insertCheck(SysRolePermission entity){
	 ...
	 * @return MessageResult 如 MessageResult.isError 则表示判断失败
	 */
	public MessageResult updateCheck(SysRolePermission entity){
	 ...
	 * @return MessageResult 如 MessageResult.isError 则表示判断失败
	 */
	public MessageResult delCheck(SysRolePermission entity){
		DefaultMessageResult mes; //消息对象
	 ...
	 * @return MessageResult 如 MessageResult.isError 则表示判断失败
	 */
	public MessageResult lgdelCheck(SysRolePermission entity){
	 ...
	 * @param entity
	 */
	public void insertOrUpdateBefore(SysRolePermission entity){
	 ...
	 * @param entity
	 */
	public void lgdelBefore(SysRolePermission entity){
	 ...
	 * @param entity
	 */
	public void delBefore(SysRolePermission entity){
	 ...
	 */
	public void insertOrUpdateBatchBefore(List<SysRolePermission> EntiyList){
	 ...
	 */
	public void lgdelBatchBefore(List<SysRolePermission> EntiyList){
		if (null==EntiyList) return ; //为空则跳出
	 ...
	 */
	public void delBatchBefore(List<SysRolePermission> EntiyList){
		if (null==EntiyList) return ; //为空则跳出
	 ...
	 * @param entity
	 */
	public void insertOrUpdateAfter(SysRolePermission entity){
	 ...
	 * @param entity
	 */
	public void lgdelAfter(SysRolePermission entity){
		if (null==entity) return ; //为空则跳出
	 ...
	 * @param entity
	 */
	public void delAfter(SysRolePermission entity){
		if (null==entity) return ; //为空则跳出
	 ...
	 * @param List<Entity> --批量（新增或更新）对象
	 */
	public void insertOrUpdateBatchAfter(List<SysRolePermission> EntiyList){
	 ...
	 * @param List<Entity> --批量（逻辑删除）对象
	 */
	public void lgdelBatchAfter(List<SysRolePermission> EntiyList){
	 ...
	 * @param List<Entity> --批量（物理删除）对象
	 */
	public void delBatchAfter(List<SysRolePermission> EntiyList){
	...
	public MessageResult batchByCheckSysRolePermission(Map<String, Object> map) throws RuntimeException {
		...
		////////////主表对象-map.get 获取的form名需要与前台保持一致//////////////
		 ...
		 SysRolePermissionSch entity=JSON.parseObject((String)(map.get("schForm")), SysRolePermissionSch.class); //form名称：schForm 由前台页面指定
		 ...
		 */
		 ...
		 ////////////明细表格对象 dg//////////////
	   	 ...
	   	 List<SysRolePermission> entityInserted=JSON.parseArray((String)jsondg.get("inserted"), SysRolePermission.class);
	   	 List<SysRolePermission> entityUpdated=JSON.parseArray((String)jsondg.get("updated"), SysRolePermission.class);
	 	 List<SysRolePermission> entitylgDeleted=JSON.parseArray((String)jsondg.get("deleted"), SysRolePermission.class);
