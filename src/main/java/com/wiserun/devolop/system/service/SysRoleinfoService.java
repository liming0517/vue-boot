...
import com.wiserun.devolop.system.dao.SysRoleinfoDao;
import com.wiserun.devolop.system.entity.SysRoleinfo;
import com.wiserun.devolop.system.entity.SysRoleinfoSch;
import com.wiserun.devolop.system.service.SysRoleinfoService;//用于读取代码表数据
...
@Service
public class SysRoleinfoService extends CrudService<SysRoleinfo, SysRoleinfoDao> {
	 ...
	 * 无业务需求则可不做任何处理 
	 */
	public void setInfoByID(SysRoleinfo entity) {
		
		 //根据实际需要扩展--如前台已传入相应数据，这里也可以不做任何处理，以提高执行效率
		SysRoleinfo sysRoleinfo;
		if(null!=entity.getId()){
			sysRoleinfo=SysRoleinfoservice.get(entity.getId());
			
			if (null!=sysRoleinfo){
	           //entity.setProjectTypeCode(sysRoleinfo.getDetailCode()); //项目代码
	           //entity.setProjectTypeName(sysRoleinfo.getCodeName()); //项目名称
			}
		}
	 ...
	 * 无业务需求则可不做任何处理 
	 */
	public void setInfoByName(SysRoleinfo entity) {
	 ...
	 * @param entity
	 */
	public ExpressionQuery queryNoLimitBefore(SysRoleinfoSch entity){
	 ...
	 * @param entity
	 */
	public ExpressionQuery queryBefore(SysRoleinfoSch entity){
		ExpressionQuery query = new ExpressionQuery();
		query=this.buildExpressionQuery(entity);
	 ...
	 */
	public MessageResult insertCheck(SysRoleinfo entity){
	 ...
	 * @return MessageResult 如 MessageResult.isError 则表示判断失败
	 */
	public MessageResult updateCheck(SysRoleinfo entity){
	 ...
	 * @return MessageResult 如 MessageResult.isError 则表示判断失败
	 */
	public MessageResult delCheck(SysRoleinfo entity){
		DefaultMessageResult mes; //消息对象
	 ...
	 * @return MessageResult 如 MessageResult.isError 则表示判断失败
	 */
	public MessageResult lgdelCheck(SysRoleinfo entity){
	 ...
	 * @param entity
	 */
	public void insertOrUpdateBefore(SysRoleinfo entity){
	 ...
	 * @param entity
	 */
	public void lgdelBefore(SysRoleinfo entity){
	 ...
	 * @param entity
	 */
	public void delBefore(SysRoleinfo entity){
	 ...
	 */
	public void insertOrUpdateBatchBefore(List<SysRoleinfo> EntiyList){
	 ...
	 */
	public void lgdelBatchBefore(List<SysRoleinfo> EntiyList){
		if (null==EntiyList) return ; //为空则跳出
	 ...
	 */
	public void delBatchBefore(List<SysRoleinfo> EntiyList){
		if (null==EntiyList) return ; //为空则跳出
	 ...
	 * @param entity
	 */
	public void insertOrUpdateAfter(SysRoleinfo entity){
	 ...
	 * @param entity
	 */
	public void lgdelAfter(SysRoleinfo entity){
		if (null==entity) return ; //为空则跳出
	 ...
	 * @param entity
	 */
	public void delAfter(SysRoleinfo entity){
		if (null==entity) return ; //为空则跳出
	 ...
	 * @param List<Entity> --批量（新增或更新）对象
	 */
	public void insertOrUpdateBatchAfter(List<SysRoleinfo> EntiyList){
	 ...
	 * @param List<Entity> --批量（逻辑删除）对象
	 */
	public void lgdelBatchAfter(List<SysRoleinfo> EntiyList){
	 ...
	 * @param List<Entity> --批量（物理删除）对象
	 */
	public void delBatchAfter(List<SysRoleinfo> EntiyList){
	...
	public MessageResult batchByCheckSysRoleinfo(Map<String, Object> map) throws RuntimeException {
		...
		////////////主表对象-map.get 获取的form名需要与前台保持一致//////////////
		 ...
		 SysRoleinfoSch entity=JSON.parseObject((String)(map.get("schForm")), SysRoleinfoSch.class); //form名称：schForm 由前台页面指定
		 ...
		 */
		 ...
		 ////////////明细表格对象 dg//////////////
	   	 ...
	   	 List<SysRoleinfo> entityInserted=JSON.parseArray((String)jsondg.get("inserted"), SysRoleinfo.class);
	   	 List<SysRoleinfo> entityUpdated=JSON.parseArray((String)jsondg.get("updated"), SysRoleinfo.class);
	 	 List<SysRoleinfo> entitylgDeleted=JSON.parseArray((String)jsondg.get("deleted"), SysRoleinfo.class);
