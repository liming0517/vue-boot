...
@Service
public class SysResService extends CrudService<SysRes, SysResDao> {
	 ...
	 * 无业务需求则可不做任何处理 
	 */
	public void setInfoByID(SysRes entity) {
		
		 //根据实际需要扩展--如前台已传入相应数据，这里也可以不做任何处理，以提高执行效率
		SysRes sysRes;
		if(null!=entity.getId()){
			sysRes=sysResservice.get(entity.getId());
			
			if (null!=sysRes){
	           //entity.setProjectTypeCode(sysRes.getDetailCode()); //项目代码
	           //entity.setProjectTypeName(sysRes.getCodeName()); //项目名称
			}
		}
	 ...
	 * 无业务需求则可不做任何处理 
	 */
	public void setInfoByName(SysRes entity) {
	 ...
	 * @param entity
	 */
	public ExpressionQuery queryNoLimitBefore(SysResSch entity){
	 ...
	 * @param entity
	 */
	public ExpressionQuery queryBefore(SysResSch entity){
		ExpressionQuery query = new ExpressionQuery();
		query=this.buildExpressionQuery(entity);
	 ...
	 */
	public MessageResult insertCheck(SysRes entity){
	 ...
	 * @return MessageResult 如 MessageResult.isError 则表示判断失败
	 */
	public MessageResult updateCheck(SysRes entity){
	 ...
	 * @return MessageResult 如 MessageResult.isError 则表示判断失败
	 */
	public MessageResult delCheck(SysRes entity){
		DefaultMessageResult mes; //消息对象
	 ...
	 * @return MessageResult 如 MessageResult.isError 则表示判断失败
	 */
	public MessageResult lgdelCheck(SysRes entity){
	 ...
	 * @param entity
	 */
	public void insertOrUpdateBefore(SysRes entity){
	 ...
	 * @param entity
	 */
	public void lgdelBefore(SysRes entity){
	 ...
	 * @param entity
	 */
	public void delBefore(SysRes entity){
	 ...
	 */
	public void insertOrUpdateBatchBefore(List<SysRes> EntiyList){
	 ...
	 */
	public void lgdelBatchBefore(List<SysRes> EntiyList){
		if (null==EntiyList) return ; //为空则跳出
	 ...
	 */
	public void delBatchBefore(List<SysRes> EntiyList){
		if (null==EntiyList) return ; //为空则跳出
	 ...
	 * @param entity
	 */
	public void insertOrUpdateAfter(SysRes entity){
	 ...
	 * @param entity
	 */
	public void lgdelAfter(SysRes entity){
		if (null==entity) return ; //为空则跳出
	 ...
	 * @param entity
	 */
	public void delAfter(SysRes entity){
		if (null==entity) return ; //为空则跳出
	 ...
	 * @param List<Entity> --批量（新增或更新）对象
	 */
	public void insertOrUpdateBatchAfter(List<SysRes> EntiyList){
	 ...
	 * @param List<Entity> --批量（逻辑删除）对象
	 */
	public void lgdelBatchAfter(List<SysRes> EntiyList){
	 ...
	 * @param List<Entity> --批量（物理删除）对象
	 */
	public void delBatchAfter(List<SysRes> EntiyList){
	...
	public MessageResult batchByCheckSysRes(Map<String, Object> map) throws RuntimeException {
		...
		////////////主表对象-map.get 获取的form名需要与前台保持一致//////////////
		 ...
		 SysResSch entity=JSON.parseObject((String)(map.get("schForm")), SysResSch.class); //form名称：schForm 由前台页面指定
		 ...
		 */
		 ...
		 ////////////明细表格对象 dg//////////////
	   	 ...
	   	 List<SysRes> entityInserted=JSON.parseArray((String)jsondg.get("inserted"), SysRes.class);
	   	 List<SysRes> entityUpdated=JSON.parseArray((String)jsondg.get("updated"), SysRes.class);
	 	 List<SysRes> entitylgDeleted=JSON.parseArray((String)jsondg.get("deleted"), SysRes.class);
	 ...
	 * @return 返回用户菜单列表
	 */
	public List<UserMenu> getUserMenu(String userId){
		List<SysUserRole> roles = sysUserRoleservice.getUserRole(userId);
		...
		System.out.println(" 菜单数量===="+list.size());
		List<UserMenu> menus = new ArrayList<UserMenu>(list.size());
		
		UserMenu menu = null;
		for (SysRes rSysRes : list) {
			menu = new UserMenu();
			menu.setMenuId(rSysRes.getId());
			menu.setText(rSysRes.getResName());
			//menu.setText(rSysRes.getResText());
	 ...
	 * @return
	 */
	public List<SysRes> getAllRSysRes(){
