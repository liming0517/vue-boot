...
import com.wiserun.devolop.system.dao.SysDeptRoleDao;
import com.wiserun.devolop.system.entity.SysDeptRole;
import com.wiserun.devolop.system.entity.SysDeptRoleSch;
import com.wiserun.devolop.system.service.SysDeptRoleService;//用于读取代码表数据
...
@Service
public class SysDeptRoleService extends CrudService<SysDeptRole, SysDeptRoleDao> {
	 ...
	 * 无业务需求则可不做任何处理 
	 */
	public void setInfoByID(SysDeptRole entity) {
		
		 //根据实际需要扩展--如前台已传入相应数据，这里也可以不做任何处理，以提高执行效率
		SysDeptRole sysDeptRole;
		if(null!=entity.getId()){
			sysDeptRole=SysDeptRoleservice.get(entity.getId());
			
			if (null!=sysDeptRole){
	           //entity.setProjectTypeCode(sysDeptRole.getDetailCode()); //项目代码
	           //entity.setProjectTypeName(sysDeptRole.getCodeName()); //项目名称
			}
		}
	 ...
	 * 无业务需求则可不做任何处理 
	 */
	public void setInfoByName(SysDeptRole entity) {
	 ...
	 * @param entity
	 */
	public ExpressionQuery queryNoLimitBefore(SysDeptRoleSch entity){
	 ...
	 * @param entity
	 */
	public ExpressionQuery queryBefore(SysDeptRoleSch entity){
		ExpressionQuery query = new ExpressionQuery();
		query=this.buildExpressionQuery(entity);
	 ...
	 */
	public MessageResult insertCheck(SysDeptRole entity){
	 ...
	 * @return MessageResult 如 MessageResult.isError 则表示判断失败
	 */
	public MessageResult updateCheck(SysDeptRole entity){
	 ...
	 * @return MessageResult 如 MessageResult.isError 则表示判断失败
	 */
	public MessageResult delCheck(SysDeptRole entity){
		DefaultMessageResult mes; //消息对象
	 ...
	 * @return MessageResult 如 MessageResult.isError 则表示判断失败
	 */
	public MessageResult lgdelCheck(SysDeptRole entity){
	 ...
	 * @param entity
	 */
	public void insertOrUpdateBefore(SysDeptRole entity){
	 ...
	 * @param entity
	 */
	public void lgdelBefore(SysDeptRole entity){
	 ...
	 * @param entity
	 */
	public void delBefore(SysDeptRole entity){
	 ...
	 */
	public void insertOrUpdateBatchBefore(List<SysDeptRole> EntiyList){
	 ...
	 */
	public void lgdelBatchBefore(List<SysDeptRole> EntiyList){
		if (null==EntiyList) return ; //为空则跳出
	 ...
	 */
	public void delBatchBefore(List<SysDeptRole> EntiyList){
		if (null==EntiyList) return ; //为空则跳出
	 ...
	 * @param entity
	 */
	public void insertOrUpdateAfter(SysDeptRole entity){
	 ...
	 * @param entity
	 */
	public void lgdelAfter(SysDeptRole entity){
		if (null==entity) return ; //为空则跳出
	 ...
	 * @param entity
	 */
	public void delAfter(SysDeptRole entity){
		if (null==entity) return ; //为空则跳出
	 ...
	 * @param List<Entity> --批量（新增或更新）对象
	 */
	public void insertOrUpdateBatchAfter(List<SysDeptRole> EntiyList){
	 ...
	 * @param List<Entity> --批量（逻辑删除）对象
	 */
	public void lgdelBatchAfter(List<SysDeptRole> EntiyList){
	 ...
	 * @param List<Entity> --批量（物理删除）对象
	 */
	public void delBatchAfter(List<SysDeptRole> EntiyList){
	...
	public MessageResult batchByCheckSysDeptRole(Map<String, Object> map) throws RuntimeException {
		...
		////////////主表对象-map.get 获取的form名需要与前台保持一致//////////////
		 ...
		 SysDeptRoleSch entity=JSON.parseObject((String)(map.get("schForm")), SysDeptRoleSch.class); //form名称：schForm 由前台页面指定
		 ...
		 */
		 ...
		 ////////////明细表格对象 dg//////////////
	   	 ...
	   	 List<SysDeptRole> entityInserted=JSON.parseArray((String)jsondg.get("inserted"), SysDeptRole.class);
	   	 List<SysDeptRole> entityUpdated=JSON.parseArray((String)jsondg.get("updated"), SysDeptRole.class);
	 	 List<SysDeptRole> entitylgDeleted=JSON.parseArray((String)jsondg.get("deleted"), SysDeptRole.class);
