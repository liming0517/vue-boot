...
import com.wiserun.devolop.system.dao.SysDeptUserDao;
import com.wiserun.devolop.system.entity.SysDeptUser;
import com.wiserun.devolop.system.entity.SysDeptUserSch;
import com.wiserun.devolop.system.service.SysDeptUserService;//用于读取代码表数据
...
@Service
public class SysDeptUserService extends CrudService<SysDeptUser, SysDeptUserDao> {
	 ...
	 * 无业务需求则可不做任何处理 
	 */
	public void setInfoByID(SysDeptUser entity) {
		
		 //根据实际需要扩展--如前台已传入相应数据，这里也可以不做任何处理，以提高执行效率
		SysDeptUser sysDeptUser;
		if(null!=entity.getId()){
			sysDeptUser=SysDeptUserservice.get(entity.getId());
			
			if (null!=sysDeptUser){
	           //entity.setProjectTypeCode(sysDeptUser.getDetailCode()); //项目代码
	           //entity.setProjectTypeName(sysDeptUser.getCodeName()); //项目名称
			}
		}
	 ...
	 * 无业务需求则可不做任何处理 
	 */
	public void setInfoByName(SysDeptUser entity) {
	 ...
	 * @param entity
	 */
	public ExpressionQuery queryNoLimitBefore(SysDeptUserSch entity){
	 ...
	 * @param entity
	 */
	public ExpressionQuery queryBefore(SysDeptUserSch entity){
		ExpressionQuery query = new ExpressionQuery();
		query=this.buildExpressionQuery(entity);
	 ...
	 */
	public MessageResult insertCheck(SysDeptUser entity){
	 ...
	 * @return MessageResult 如 MessageResult.isError 则表示判断失败
	 */
	public MessageResult updateCheck(SysDeptUser entity){
	 ...
	 * @return MessageResult 如 MessageResult.isError 则表示判断失败
	 */
	public MessageResult delCheck(SysDeptUser entity){
		DefaultMessageResult mes; //消息对象
	 ...
	 * @return MessageResult 如 MessageResult.isError 则表示判断失败
	 */
	public MessageResult lgdelCheck(SysDeptUser entity){
	 ...
	 * @param entity
	 */
	public void insertOrUpdateBefore(SysDeptUser entity){
	 ...
	 * @param entity
	 */
	public void lgdelBefore(SysDeptUser entity){
	 ...
	 * @param entity
	 */
	public void delBefore(SysDeptUser entity){
	 ...
	 */
	public void insertOrUpdateBatchBefore(List<SysDeptUser> EntiyList){
	 ...
	 */
	public void lgdelBatchBefore(List<SysDeptUser> EntiyList){
		if (null==EntiyList) return ; //为空则跳出
	 ...
	 */
	public void delBatchBefore(List<SysDeptUser> EntiyList){
		if (null==EntiyList) return ; //为空则跳出
	 ...
	 * @param entity
	 */
	public void insertOrUpdateAfter(SysDeptUser entity){
	 ...
	 * @param entity
	 */
	public void lgdelAfter(SysDeptUser entity){
		if (null==entity) return ; //为空则跳出
	 ...
	 * @param entity
	 */
	public void delAfter(SysDeptUser entity){
		if (null==entity) return ; //为空则跳出
	 ...
	 * @param List<Entity> --批量（新增或更新）对象
	 */
	public void insertOrUpdateBatchAfter(List<SysDeptUser> EntiyList){
	 ...
	 * @param List<Entity> --批量（逻辑删除）对象
	 */
	public void lgdelBatchAfter(List<SysDeptUser> EntiyList){
	 ...
	 * @param List<Entity> --批量（物理删除）对象
	 */
	public void delBatchAfter(List<SysDeptUser> EntiyList){
	...
	public MessageResult batchByCheckSysDeptUser(Map<String, Object> map) throws RuntimeException {
		...
		////////////主表对象-map.get 获取的form名需要与前台保持一致//////////////
		 ...
		 SysDeptUserSch entity=JSON.parseObject((String)(map.get("schForm")), SysDeptUserSch.class); //form名称：schForm 由前台页面指定
		 ...
		 */
		 ...
		 ////////////明细表格对象 dg//////////////
	   	 ...
	   	 List<SysDeptUser> entityInserted=JSON.parseArray((String)jsondg.get("inserted"), SysDeptUser.class);
	   	 List<SysDeptUser> entityUpdated=JSON.parseArray((String)jsondg.get("updated"), SysDeptUser.class);
	 	 List<SysDeptUser> entitylgDeleted=JSON.parseArray((String)jsondg.get("deleted"), SysDeptUser.class);
