...
import com.wiserun.devolop.system.dao.SysBasdeptinfoDao;
import com.wiserun.devolop.system.entity.SysBasdeptinfo;
import com.wiserun.devolop.system.entity.SysBasdeptinfoSch;
import com.wiserun.devolop.system.service.SysBasdeptinfoService;//用于读取代码表数据
...
@Service
public class SysBasdeptinfoService extends CrudService<SysBasdeptinfo, SysBasdeptinfoDao> {
	
	@Autowired
	SysBasdeptinfoService SysBasdeptinfoservice;
	 ...
	 * 无业务需求则可不做任何处理 
	 */
	public void setInfoByID(SysBasdeptinfo entity) {
		
		 //根据实际需要扩展--如前台已传入相应数据，这里也可以不做任何处理，以提高执行效率
		SysBasdeptinfo sysBasdeptinfo;
		if(null!=entity.getId()){
			sysBasdeptinfo=SysBasdeptinfoservice.get(entity.getId());
			
			if (null!=sysBasdeptinfo){
	           //entity.setProjectTypeCode(sysBasdeptinfo.getDetailCode()); //项目代码
	           //entity.setProjectTypeName(sysBasdeptinfo.getCodeName()); //项目名称
			}
		}
	 ...
	 * 无业务需求则可不做任何处理 
	 */
	public void setInfoByName(SysBasdeptinfo entity) {
	 ...
	 * @param entity
	 */
	public ExpressionQuery queryNoLimitBefore(SysBasdeptinfoSch entity){
	 ...
	 * @param entity
	 */
	public ExpressionQuery queryBefore(SysBasdeptinfoSch entity){
		ExpressionQuery query = new ExpressionQuery();
		query=this.buildExpressionQuery(entity);
	 ...
	 */
	public MessageResult insertCheck(SysBasdeptinfo entity){
	 ...
	 * @return MessageResult 如 MessageResult.isError 则表示判断失败
	 */
	public MessageResult updateCheck(SysBasdeptinfo entity){
	 ...
	 * @return MessageResult 如 MessageResult.isError 则表示判断失败
	 */
	public MessageResult delCheck(SysBasdeptinfo entity){
		DefaultMessageResult mes; //消息对象
	 ...
	 * @return MessageResult 如 MessageResult.isError 则表示判断失败
	 */
	public MessageResult lgdelCheck(SysBasdeptinfo entity){
	 ...
	 * @param entity
	 */
	public void insertOrUpdateBefore(SysBasdeptinfo entity){
	 ...
	 * @param entity
	 */
	public void lgdelBefore(SysBasdeptinfo entity){
	 ...
	 * @param entity
	 */
	public void delBefore(SysBasdeptinfo entity){
	 ...
	 */
	public void insertOrUpdateBatchBefore(List<SysBasdeptinfo> EntiyList){
	 ...
	 */
	public void lgdelBatchBefore(List<SysBasdeptinfo> EntiyList){
		if (null==EntiyList) return ; //为空则跳出
	 ...
	 */
	public void delBatchBefore(List<SysBasdeptinfo> EntiyList){
		if (null==EntiyList) return ; //为空则跳出
	 ...
	 * @param entity
	 */
	public void insertOrUpdateAfter(SysBasdeptinfo entity){
	 ...
	 * @param entity
	 */
	public void lgdelAfter(SysBasdeptinfo entity){
		if (null==entity) return ; //为空则跳出
	 ...
	 * @param entity
	 */
	public void delAfter(SysBasdeptinfo entity){
		if (null==entity) return ; //为空则跳出
	 ...
	 * @param List<Entity> --批量（新增或更新）对象
	 */
	public void insertOrUpdateBatchAfter(List<SysBasdeptinfo> EntiyList){
	 ...
	 * @param List<Entity> --批量（逻辑删除）对象
	 */
	public void lgdelBatchAfter(List<SysBasdeptinfo> EntiyList){
	 ...
	 * @param List<Entity> --批量（物理删除）对象
	 */
	public void delBatchAfter(List<SysBasdeptinfo> EntiyList){
	...
	public MessageResult batchByCheckSysBasdeptinfo(Map<String, Object> map) throws RuntimeException {
		...
		////////////主表对象-map.get 获取的form名需要与前台保持一致//////////////
		 ...
		 SysBasdeptinfoSch entity=JSON.parseObject((String)(map.get("schForm")), SysBasdeptinfoSch.class); //form名称：schForm 由前台页面指定
		 ...
		 */
		 ...
		 ////////////明细表格对象 dg//////////////
	   	 ...
	   	 List<SysBasdeptinfo> entityInserted=JSON.parseArray((String)jsondg.get("inserted"), SysBasdeptinfo.class);
	   	 List<SysBasdeptinfo> entityUpdated=JSON.parseArray((String)jsondg.get("updated"), SysBasdeptinfo.class);
	 	 List<SysBasdeptinfo> entitylgDeleted=JSON.parseArray((String)jsondg.get("deleted"), SysBasdeptinfo.class);
