...
import com.wiserun.devolop.system.dao.SysResTabDao;
import com.wiserun.devolop.system.entity.SysResTab;
import com.wiserun.devolop.system.entity.SysResTabSch;
import com.wiserun.devolop.system.service.SysResTabService;//用于读取代码表数据
...
@Service
public class SysResTabService extends CrudService<SysResTab, SysResTabDao> {
	
	@Autowired
	SysResTabService SysResTabservice;
	 ...
	 * 无业务需求则可不做任何处理 
	 */
	public void setInfoByID(SysResTab entity) {
		
		 //根据实际需要扩展--如前台已传入相应数据，这里也可以不做任何处理，以提高执行效率
		SysResTab sysResTab;
		if(null!=entity.getId()){
			sysResTab=SysResTabservice.get(entity.getId());
			
			if (null!=sysResTab){
	           //entity.setProjectTypeCode(sysResTab.getDetailCode()); //项目代码
	           //entity.setProjectTypeName(sysResTab.getCodeName()); //项目名称
			}
		}
	 ...
	 * 无业务需求则可不做任何处理 
	 */
	public void setInfoByName(SysResTab entity) {
	 ...
	 * @param entity
	 */
	public ExpressionQuery queryNoLimitBefore(SysResTabSch entity){
	 ...
	 * @param entity
	 */
	public ExpressionQuery queryBefore(SysResTabSch entity){
		ExpressionQuery query = new ExpressionQuery();
		query=this.buildExpressionQuery(entity);
	 ...
	 */
	public MessageResult insertCheck(SysResTab entity){
	 ...
	 * @return MessageResult 如 MessageResult.isError 则表示判断失败
	 */
	public MessageResult updateCheck(SysResTab entity){
	 ...
	 * @return MessageResult 如 MessageResult.isError 则表示判断失败
	 */
	public MessageResult delCheck(SysResTab entity){
		DefaultMessageResult mes; //消息对象
	 ...
	 * @return MessageResult 如 MessageResult.isError 则表示判断失败
	 */
	public MessageResult lgdelCheck(SysResTab entity){
	 ...
	 * @param entity
	 */
	public void insertOrUpdateBefore(SysResTab entity){
	 ...
	 * @param entity
	 */
	public void lgdelBefore(SysResTab entity){
	 ...
	 * @param entity
	 */
	public void delBefore(SysResTab entity){
	 ...
	 */
	public void insertOrUpdateBatchBefore(List<SysResTab> EntiyList){
	 ...
	 */
	public void lgdelBatchBefore(List<SysResTab> EntiyList){
		if (null==EntiyList) return ; //为空则跳出
	 ...
	 */
	public void delBatchBefore(List<SysResTab> EntiyList){
		if (null==EntiyList) return ; //为空则跳出
	 ...
	 * @param entity
	 */
	public void insertOrUpdateAfter(SysResTab entity){
	 ...
	 * @param entity
	 */
	public void lgdelAfter(SysResTab entity){
		if (null==entity) return ; //为空则跳出
	 ...
	 * @param entity
	 */
	public void delAfter(SysResTab entity){
		if (null==entity) return ; //为空则跳出
	 ...
	 * @param List<Entity> --批量（新增或更新）对象
	 */
	public void insertOrUpdateBatchAfter(List<SysResTab> EntiyList){
	 ...
	 * @param List<Entity> --批量（逻辑删除）对象
	 */
	public void lgdelBatchAfter(List<SysResTab> EntiyList){
	 ...
	 * @param List<Entity> --批量（物理删除）对象
	 */
	public void delBatchAfter(List<SysResTab> EntiyList){
	...
	public MessageResult batchByCheckSysResTab(Map<String, Object> map) throws RuntimeException {
		...
		////////////主表对象-map.get 获取的form名需要与前台保持一致//////////////
		 ...
		 SysResTabSch entity=JSON.parseObject((String)(map.get("schForm")), SysResTabSch.class); //form名称：schForm 由前台页面指定
		 ...
		 */
		 ...
		 ////////////明细表格对象 dg//////////////
	   	 ...
	   	 List<SysResTab> entityInserted=JSON.parseArray((String)jsondg.get("inserted"), SysResTab.class);
	   	 List<SysResTab> entityUpdated=JSON.parseArray((String)jsondg.get("updated"), SysResTab.class);
	 	 List<SysResTab> entitylgDeleted=JSON.parseArray((String)jsondg.get("deleted"), SysResTab.class);
