...
import com.wiserun.devolop.system.service.SysDepartmentService;//用于读取代码表数据
...
@Service
public class SysDepartmentService extends CrudService<SysDepartment, SysDepartmentDao> {
	 ...
	 * 无业务需求则可不做任何处理 
	 */
	public void setInfoByID(SysDepartment entity) {
		
		 //根据实际需要扩展--如前台已传入相应数据，这里也可以不做任何处理，以提高执行效率
		SysDepartment sysDepartment;
		if(null!=entity.getId()){
			sysDepartment=SysDepartmentservice.get(entity.getId());
			
			if (null!=sysDepartment){
	           //entity.setProjectTypeCode(sysDepartment.getDetailCode()); //项目代码
	           //entity.setProjectTypeName(sysDepartment.getCodeName()); //项目名称
			}
		}
	 ...
	 * 无业务需求则可不做任何处理 
	 */
	public void setInfoByName(SysDepartment entity) {
	 ...
	 * @param entity
	 */
	public ExpressionQuery queryNoLimitBefore(SysDepartmentSch entity){
	 ...
	 * @param entity
	 */
	public ExpressionQuery queryBefore(SysDepartmentSch entity){
		ExpressionQuery query = new ExpressionQuery();
		query=this.buildExpressionQuery(entity);
	 ...
	 */
	public MessageResult insertCheck(SysDepartment entity){
	 ...
	 * @return MessageResult 如 MessageResult.isError 则表示判断失败
	 */
	public MessageResult updateCheck(SysDepartment entity){
	 ...
	 * @return MessageResult 如 MessageResult.isError 则表示判断失败
	 */
	public MessageResult delCheck(SysDepartment entity){
		DefaultMessageResult mes; //消息对象
	 ...
	 * @return MessageResult 如 MessageResult.isError 则表示判断失败
	 */
	public MessageResult lgdelCheck(SysDepartment entity){
	 ...
	 * @param entity
	 */
	public void insertOrUpdateBefore(SysDepartment entity){
	 ...
	 * @param entity
	 */
	public void lgdelBefore(SysDepartment entity){
	 ...
	 * @param entity
	 */
	public void delBefore(SysDepartment entity){
	 ...
	 */
	public void insertOrUpdateBatchBefore(List<SysDepartment> EntiyList){
	 ...
	 */
	public void lgdelBatchBefore(List<SysDepartment> EntiyList){
		if (null==EntiyList) return ; //为空则跳出
	 ...
	 */
	public void delBatchBefore(List<SysDepartment> EntiyList){
		if (null==EntiyList) return ; //为空则跳出
	 ...
	 * @param entity
	 */
	public void insertOrUpdateAfter(SysDepartment entity){
	 ...
	 * @param entity
	 */
	public void lgdelAfter(SysDepartment entity){
		if (null==entity) return ; //为空则跳出
	 ...
	 * @param entity
	 */
	public void delAfter(SysDepartment entity){
		if (null==entity) return ; //为空则跳出
	 ...
	 * @param List<Entity> --批量（新增或更新）对象
	 */
	public void insertOrUpdateBatchAfter(List<SysDepartment> EntiyList){
	 ...
	 * @param List<Entity> --批量（逻辑删除）对象
	 */
	public void lgdelBatchAfter(List<SysDepartment> EntiyList){
	 ...
	 * @param List<Entity> --批量（物理删除）对象
	 */
	public void delBatchAfter(List<SysDepartment> EntiyList){
	...
	public MessageResult batchByCheckSysDepartment(Map<String, Object> map) throws RuntimeException {
		...
		////////////主表对象-map.get 获取的form名需要与前台保持一致//////////////
		 ...
		 SysDepartmentSch entity=JSON.parseObject((String)(map.get("schForm")), SysDepartmentSch.class); //form名称：schForm 由前台页面指定
		 ...
		 */
		 ...
		 ////////////明细表格对象 dg//////////////
	   	 ...
	   	 List<SysDepartment> entityInserted=JSON.parseArray((String)jsondg.get("inserted"), SysDepartment.class);
	   	 List<SysDepartment> entityUpdated=JSON.parseArray((String)jsondg.get("updated"), SysDepartment.class);
	 	 List<SysDepartment> entitylgDeleted=JSON.parseArray((String)jsondg.get("deleted"), SysDepartment.class);
