...
创建人：代码生成器
Create date: **请补充**
功能说明：sys.department SearchEntity查询用途类
修订信息(**请补充**)
修订日期:**请补充**
原因:**请补充**
修订人:**请补充**
...
public class SysDepartmentSch extends SearchEasyUI {
    ...
    private String deptCodeSch; //等于条件
        private String deptCodeLike; //模糊 LIKE 条件 仅限字符型字段 nvarchar
        private String deptCodeMore; //大于条件
    private String deptCodeLess; //小于条件
    
    private String deptNameSch; //等于条件
        private String deptNameLike; //模糊 LIKE 条件 仅限字符型字段 nvarchar
        private String deptNameMore; //大于条件
    private String deptNameLess; //小于条件
    ...
    private String areaIdSch; //等于条件
        private String areaIdLike; //模糊 LIKE 条件 仅限字符型字段 nvarchar
        private String areaIdMore; //大于条件
    private String areaIdLess; //小于条件
    
    private String areaCodeSch; //等于条件
        private String areaCodeLike; //模糊 LIKE 条件 仅限字符型字段 nvarchar
        private String areaCodeMore; //大于条件
    private String areaCodeLess; //小于条件
    
    private String areaNameSch; //等于条件
        private String areaNameLike; //模糊 LIKE 条件 仅限字符型字段 nvarchar
        private String areaNameMore; //大于条件
    private String areaNameLess; //小于条件
    
    private String powerPersonSch; //等于条件
        private String powerPersonLike; //模糊 LIKE 条件 仅限字符型字段 nvarchar
        private String powerPersonMore; //大于条件
    private String powerPersonLess; //小于条件
    ...
    @ValueField(column = "deptCode") //等于条件
    public String getDeptCodeSch(){
        return this.deptCodeSch;
    }
    ...
    @LikeDoubleField(column = "deptCode") //模糊条件-仅限字符型字段
    public String getDeptCodeLike(){
    	    	    	        
        return this.deptCodeLike;
    }
    
	    //大于条件
    public void setDeptCodeMore(String deptCodeMore){
        this.deptCodeMore = deptCodeMore;
    }
    @ValueField(column = "deptCode" ,equal=">=") //大于条件
    public String getDeptCodeMore(){
        return this.deptCodeMore;
    }

	    //小于条件
    public void setDeptCodeLess(String deptCodeLess){
        this.deptCodeLess = deptCodeLess;
    }
    @ValueField(column = "deptCode" ,equal="<=") //小于条件
    public String getDeptCodeLess(){
        return this.deptCodeLess;
    }

       //等于条件
    public void setDeptNameSch(String deptNameSch){
        this.deptNameSch = deptNameSch;
    }
    @ValueField(column = "deptName") //等于条件
    public String getDeptNameSch(){
        return this.deptNameSch;
    }
    ...
    @LikeDoubleField(column = "deptName") //模糊条件-仅限字符型字段
    public String getDeptNameLike(){
    	    	    	        
        return this.deptNameLike;
    }
    
	    //大于条件
    public void setDeptNameMore(String deptNameMore){
        this.deptNameMore = deptNameMore;
    }
    @ValueField(column = "deptName" ,equal=">=") //大于条件
    public String getDeptNameMore(){
        return this.deptNameMore;
    }

	    //小于条件
    public void setDeptNameLess(String deptNameLess){
        this.deptNameLess = deptNameLess;
    }
    @ValueField(column = "deptName" ,equal="<=") //小于条件
    public String getDeptNameLess(){
        return this.deptNameLess;
    }
    ...
    public String getParentNameLess(){
       ...
       //等于条件
    public void setAreaIdSch(String areaIdSch){
        this.areaIdSch = areaIdSch;
    }
    @ValueField(column = "areaId") //等于条件
    public String getAreaIdSch(){
        return this.areaIdSch;
    }
    ...
    @LikeDoubleField(column = "areaId") //模糊条件-仅限字符型字段
    public String getAreaIdLike(){
    	    	    	        
        return this.areaIdLike;
    }
    
	    //大于条件
    public void setAreaIdMore(String areaIdMore){
        this.areaIdMore = areaIdMore;
    }
    @ValueField(column = "areaId" ,equal=">=") //大于条件
    public String getAreaIdMore(){
        return this.areaIdMore;
    }

	    //小于条件
    public void setAreaIdLess(String areaIdLess){
        this.areaIdLess = areaIdLess;
    }
    @ValueField(column = "areaId" ,equal="<=") //小于条件
    public String getAreaIdLess(){
        return this.areaIdLess;
    }

       //等于条件
    public void setAreaCodeSch(String areaCodeSch){
        this.areaCodeSch = areaCodeSch;
    }
    @ValueField(column = "areaCode") //等于条件
    public String getAreaCodeSch(){
        return this.areaCodeSch;
    }
    ...
    @LikeDoubleField(column = "areaCode") //模糊条件-仅限字符型字段
    public String getAreaCodeLike(){
    	    	    	        
        return this.areaCodeLike;
    }
    
	    //大于条件
    public void setAreaCodeMore(String areaCodeMore){
        this.areaCodeMore = areaCodeMore;
    }
    @ValueField(column = "areaCode" ,equal=">=") //大于条件
    public String getAreaCodeMore(){
        return this.areaCodeMore;
    }

	    //小于条件
    public void setAreaCodeLess(String areaCodeLess){
        this.areaCodeLess = areaCodeLess;
    }
    @ValueField(column = "areaCode" ,equal="<=") //小于条件
    public String getAreaCodeLess(){
        return this.areaCodeLess;
    }

       //等于条件
    public void setAreaNameSch(String areaNameSch){
        this.areaNameSch = areaNameSch;
    }
    @ValueField(column = "areaName") //等于条件
    public String getAreaNameSch(){
        return this.areaNameSch;
    }
    ...
    @LikeDoubleField(column = "areaName") //模糊条件-仅限字符型字段
    public String getAreaNameLike(){
	    ...
	    //大于条件
    public void setAreaNameMore(String areaNameMore){
        this.areaNameMore = areaNameMore;
    }
    @ValueField(column = "areaName" ,equal=">=") //大于条件
    public String getAreaNameMore(){
        return this.areaNameMore;
    }

	    //小于条件
    public void setAreaNameLess(String areaNameLess){
        this.areaNameLess = areaNameLess;
    }
    @ValueField(column = "areaName" ,equal="<=") //小于条件
    public String getAreaNameLess(){
        return this.areaNameLess;
    }

       //等于条件
    public void setPowerPersonSch(String powerPersonSch){
        this.powerPersonSch = powerPersonSch;
    }
    @ValueField(column = "powerPerson") //等于条件
    public String getPowerPersonSch(){
        return this.powerPersonSch;
    }

              //模糊条件-仅限字符型字段
    public void setPowerPersonLike(String powerPersonLike){
        this.powerPersonLike = powerPersonLike;
    }
    @LikeDoubleField(column = "powerPerson") //模糊条件-仅限字符型字段
    public String getPowerPersonLike(){
    	    	    	        
        return this.powerPersonLike;
    }
    
	    //大于条件
    public void setPowerPersonMore(String powerPersonMore){
        this.powerPersonMore = powerPersonMore;
    }
    @ValueField(column = "powerPerson" ,equal=">=") //大于条件
    public String getPowerPersonMore(){
        return this.powerPersonMore;
    }

	    //小于条件
    public void setPowerPersonLess(String powerPersonLess){
        this.powerPersonLess = powerPersonLess;
    }
    @ValueField(column = "powerPerson" ,equal="<=") //小于条件
    public String getPowerPersonLess(){
        return this.powerPersonLess;
    }
