...
创建人：代码生成器
Create date: **请补充**
功能说明：sys.restab SearchEntity查询用途类
修订信息(**请补充**)
修订日期:**请补充**
原因:**请补充**
修订人:**请补充**
...
public class SysResTabSch extends SearchEasyUI {
    ...
    private String tabNameSch; //等于条件
        private String tabNameLike; //模糊 LIKE 条件 仅限字符型字段 nvarchar
        private String tabNameMore; //大于条件
    private String tabNameLess; //小于条件
    ...
    @ValueField(column = "tabName") //等于条件
    public String getTabNameSch(){
        return this.tabNameSch;
    }

              //模糊条件-仅限字符型字段
    public void setTabNameLike(String tabNameLike){
        this.tabNameLike = tabNameLike;
    }
    @LikeDoubleField(column = "tabName") //模糊条件-仅限字符型字段
    public String getTabNameLike(){
    	    	    	        
        return this.tabNameLike;
    }
    
	    //大于条件
    public void setTabNameMore(String tabNameMore){
        this.tabNameMore = tabNameMore;
    }
    @ValueField(column = "tabName" ,equal=">=") //大于条件
    public String getTabNameMore(){
        return this.tabNameMore;
    }

	    //小于条件
    public void setTabNameLess(String tabNameLess){
        this.tabNameLess = tabNameLess;
    }
    @ValueField(column = "tabName" ,equal="<=") //小于条件
    public String getTabNameLess(){
        return this.tabNameLess;
    }
