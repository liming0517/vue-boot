...
创建人：代码生成器
Create date: **请补充**
功能说明：sys.area SearchEntity查询用途类
修订信息(**请补充**)
修订日期:**请补充**
原因:**请补充**
修订人:**请补充**
...
public class SysAreaSch extends SearchEasyUI {
    ...
    private String areaTypeSch; //等于条件
        private String areaTypeLike; //模糊 LIKE 条件 仅限字符型字段 nvarchar
        private String areaTypeMore; //大于条件
    private String areaTypeLess; //小于条件
    ...
    public String getAreaNameLess(){
       ...
       //等于条件
    public void setAreaTypeSch(String areaTypeSch){
        this.areaTypeSch = areaTypeSch;
    }
    @ValueField(column = "areaType") //等于条件
    public String getAreaTypeSch(){
        return this.areaTypeSch;
    }

              //模糊条件-仅限字符型字段
    public void setAreaTypeLike(String areaTypeLike){
        this.areaTypeLike = areaTypeLike;
    }
    @LikeDoubleField(column = "areaType") //模糊条件-仅限字符型字段
    public String getAreaTypeLike(){
    	    	    	        
        return this.areaTypeLike;
    }
    
	    //大于条件
    public void setAreaTypeMore(String areaTypeMore){
        this.areaTypeMore = areaTypeMore;
    }
    @ValueField(column = "areaType" ,equal=">=") //大于条件
    public String getAreaTypeMore(){
        return this.areaTypeMore;
    }

	    //小于条件
    public void setAreaTypeLess(String areaTypeLess){
        this.areaTypeLess = areaTypeLess;
    }
    @ValueField(column = "areaType" ,equal="<=") //小于条件
    public String getAreaTypeLess(){
        return this.areaTypeLess;
    }
