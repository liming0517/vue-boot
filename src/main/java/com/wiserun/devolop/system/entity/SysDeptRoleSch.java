...
创建人：代码生成器
Create date: **请补充**
功能说明：sys.deptrole SearchEntity查询用途类
修订信息(**请补充**)
修订日期:**请补充**
原因:**请补充**
修订人:**请补充**
...
public class SysDeptRoleSch extends SearchEasyUI {
    ...
    private String seqtableSch; //等于条件
        private String seqtableLike; //模糊 LIKE 条件 仅限字符型字段 nvarchar
        private String seqtableMore; //大于条件
    private String seqtableLess; //小于条件
    
    private String seqleadSch; //等于条件
        private String seqleadLike; //模糊 LIKE 条件 仅限字符型字段 nvarchar
        private String seqleadMore; //大于条件
    private String seqleadLess; //小于条件
    
    private String seqvalueSch; //等于条件
        private String seqvalueLike; //模糊 LIKE 条件 仅限字符型字段 nvarchar
        private String seqvalueMore; //大于条件
    private String seqvalueLess; //小于条件
    ...
    public String getStateLess(){
       ...
       //等于条件
    public void setSeqtableSch(String seqtableSch){
        this.seqtableSch = seqtableSch;
    }
    @ValueField(column = "seqtable") //等于条件
    public String getSeqtableSch(){
        return this.seqtableSch;
    }

              //模糊条件-仅限字符型字段
    public void setSeqtableLike(String seqtableLike){
        this.seqtableLike = seqtableLike;
    }
    @LikeDoubleField(column = "seqtable") //模糊条件-仅限字符型字段
    public String getSeqtableLike(){
    	    	    	        
        return this.seqtableLike;
    }
    
	    //大于条件
    public void setSeqtableMore(String seqtableMore){
        this.seqtableMore = seqtableMore;
    }
    @ValueField(column = "seqtable" ,equal=">=") //大于条件
    public String getSeqtableMore(){
        return this.seqtableMore;
    }

	    //小于条件
    public void setSeqtableLess(String seqtableLess){
        this.seqtableLess = seqtableLess;
    }
    @ValueField(column = "seqtable" ,equal="<=") //小于条件
    public String getSeqtableLess(){
        return this.seqtableLess;
    }

       //等于条件
    public void setSeqleadSch(String seqleadSch){
        this.seqleadSch = seqleadSch;
    }
    @ValueField(column = "seqlead") //等于条件
    public String getSeqleadSch(){
        return this.seqleadSch;
    }

              //模糊条件-仅限字符型字段
    public void setSeqleadLike(String seqleadLike){
        this.seqleadLike = seqleadLike;
    }
    @LikeDoubleField(column = "seqlead") //模糊条件-仅限字符型字段
    public String getSeqleadLike(){
    	    	    	        
        return this.seqleadLike;
    }
    
	    //大于条件
    public void setSeqleadMore(String seqleadMore){
        this.seqleadMore = seqleadMore;
    }
    @ValueField(column = "seqlead" ,equal=">=") //大于条件
    public String getSeqleadMore(){
        return this.seqleadMore;
    }

	    //小于条件
    public void setSeqleadLess(String seqleadLess){
        this.seqleadLess = seqleadLess;
    }
    @ValueField(column = "seqlead" ,equal="<=") //小于条件
    public String getSeqleadLess(){
        return this.seqleadLess;
    }

       //等于条件
    public void setSeqvalueSch(String seqvalueSch){
        this.seqvalueSch = seqvalueSch;
    }
    @ValueField(column = "seqvalue") //等于条件
    public String getSeqvalueSch(){
        return this.seqvalueSch;
    }

              //模糊条件-仅限字符型字段
    public void setSeqvalueLike(String seqvalueLike){
        this.seqvalueLike = seqvalueLike;
    }
    @LikeDoubleField(column = "seqvalue") //模糊条件-仅限字符型字段
    public String getSeqvalueLike(){
    	    	    	        
        return this.seqvalueLike;
    }
    
	    //大于条件
    public void setSeqvalueMore(String seqvalueMore){
        this.seqvalueMore = seqvalueMore;
    }
    @ValueField(column = "seqvalue" ,equal=">=") //大于条件
    public String getSeqvalueMore(){
        return this.seqvalueMore;
    }

	    //小于条件
    public void setSeqvalueLess(String seqvalueLess){
        this.seqvalueLess = seqvalueLess;
    }
    @ValueField(column = "seqvalue" ,equal="<=") //小于条件
    public String getSeqvalueLess(){
        return this.seqvalueLess;
    }
