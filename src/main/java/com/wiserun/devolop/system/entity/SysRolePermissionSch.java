...
创建人：代码生成器
Create date: **请补充**
功能说明：sys.rolepermission SearchEntity查询用途类
修订信息(**请补充**)
修订日期:**请补充**
原因:**请补充**
修订人:**请补充**
...
public class SysRolePermissionSch extends SearchEasyUI {
    ...
    private String roleIdSch; //等于条件
        private String roleIdLike; //模糊 LIKE 条件 仅限字符型字段 nvarchar
        private String roleIdMore; //大于条件
    private String roleIdLess; //小于条件
    
    private String sfIdSch; //等于条件
        private String sfIdLike; //模糊 LIKE 条件 仅限字符型字段 nvarchar
        private String sfIdMore; //大于条件
    private String sfIdLess; //小于条件
    ...
    public String getStateLess(){
       ...
       //等于条件
    public void setRoleIdSch(String roleIdSch){
        this.roleIdSch = roleIdSch;
    }
    @ValueField(column = "roleId") //等于条件
    public String getRoleIdSch(){
    ...
    @LikeDoubleField(column = "roleId") //模糊条件-仅限字符型字段
    public String getRoleIdLike(){
	    ...
	    //大于条件
    public void setRoleIdMore(String roleIdMore){
        this.roleIdMore = roleIdMore;
    }
    @ValueField(column = "roleId" ,equal=">=") //大于条件
    public String getRoleIdMore(){
        return this.roleIdMore;
    }

	    //小于条件
    public void setRoleIdLess(String roleIdLess){
        this.roleIdLess = roleIdLess;
    }
    @ValueField(column = "roleId" ,equal="<=") //小于条件
    public String getRoleIdLess(){
        return this.roleIdLess;
    }

       //等于条件
    public void setSfIdSch(String sfIdSch){
        this.sfIdSch = sfIdSch;
    }
    @ValueField(column = "sfId") //等于条件
    public String getSfIdSch(){
        return this.sfIdSch;
    }

              //模糊条件-仅限字符型字段
    public void setSfIdLike(String sfIdLike){
        this.sfIdLike = sfIdLike;
    }
    @LikeDoubleField(column = "sfId") //模糊条件-仅限字符型字段
    public String getSfIdLike(){
    	    	    	        
        return this.sfIdLike;
    }
    
	    //大于条件
    public void setSfIdMore(String sfIdMore){
        this.sfIdMore = sfIdMore;
    }
    @ValueField(column = "sfId" ,equal=">=") //大于条件
    public String getSfIdMore(){
        return this.sfIdMore;
    }

	    //小于条件
    public void setSfIdLess(String sfIdLess){
        this.sfIdLess = sfIdLess;
    }
    @ValueField(column = "sfId" ,equal="<=") //小于条件
    public String getSfIdLess(){
        return this.sfIdLess;
    }
