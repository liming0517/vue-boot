...
创建人：代码生成器
Create date: **请补充**
功能说明：sys.res SearchEntity查询用途类
修订信息(**请补充**)
修订日期:**请补充**
原因:**请补充**
修订人:**请补充**
...
public class SysResSch extends SearchEasyUI {
    ...
    private String resNameSch; //等于条件
        private String resNameLike; //模糊 LIKE 条件 仅限字符型字段 nvarchar
        private String resNameMore; //大于条件
    private String resNameLess; //小于条件
    
    private String tabIdSch; //等于条件
        private String tabIdLike; //模糊 LIKE 条件 仅限字符型字段 nvarchar
        private String tabIdMore; //大于条件
    private String tabIdLess; //小于条件
    ...
    private String resTypeSch; //等于条件
        private String resTypeLike; //模糊 LIKE 条件 仅限字符型字段 nvarchar
        private String resTypeMore; //大于条件
    private String resTypeLess; //小于条件
    ...
    @ValueField(column = "resName") //等于条件
    ...
    @LikeDoubleField(column = "resName") //模糊条件-仅限字符型字段
    public String getResNameLike(){
    	    	    	        
        return this.resNameLike;
    }
    
	    //大于条件
    public void setResNameMore(String resNameMore){
        this.resNameMore = resNameMore;
    }
    @ValueField(column = "resName" ,equal=">=") //大于条件
    public String getResNameMore(){
        return this.resNameMore;
    }

	    //小于条件
    public void setResNameLess(String resNameLess){
        this.resNameLess = resNameLess;
    }
    @ValueField(column = "resName" ,equal="<=") //小于条件
    public String getResNameLess(){
        return this.resNameLess;
    }

       //等于条件
    public void setTabIdSch(String tabIdSch){
        this.tabIdSch = tabIdSch;
    }
    @ValueField(column = "tabId") //等于条件
    public String getTabIdSch(){
        return this.tabIdSch;
    }

              //模糊条件-仅限字符型字段
    public void setTabIdLike(String tabIdLike){
        this.tabIdLike = tabIdLike;
    }
    @LikeDoubleField(column = "tabId") //模糊条件-仅限字符型字段
    public String getTabIdLike(){
    	    	    	        
        return this.tabIdLike;
    }
    
	    //大于条件
    public void setTabIdMore(String tabIdMore){
        this.tabIdMore = tabIdMore;
    }
    @ValueField(column = "tabId" ,equal=">=") //大于条件
    public String getTabIdMore(){
        return this.tabIdMore;
    }

	    //小于条件
    public void setTabIdLess(String tabIdLess){
        this.tabIdLess = tabIdLess;
    }
    @ValueField(column = "tabId" ,equal="<=") //小于条件
    public String getTabIdLess(){
        return this.tabIdLess;
    }
    ...
    public String getUrlLess(){
       ...
       //等于条件
    public void setResTypeSch(String resTypeSch){
        this.resTypeSch = resTypeSch;
    }
    @ValueField(column = "resType") //等于条件
    public String getResTypeSch(){
        return this.resTypeSch;
    }
    ...
    @LikeDoubleField(column = "resType") //模糊条件-仅限字符型字段
    public String getResTypeLike(){
    	    	    	        
        return this.resTypeLike;
    }
    
	    //大于条件
    public void setResTypeMore(String resTypeMore){
        this.resTypeMore = resTypeMore;
    }
    @ValueField(column = "resType" ,equal=">=") //大于条件
    public String getResTypeMore(){
        return this.resTypeMore;
    }

	    //小于条件
    public void setResTypeLess(String resTypeLess){
        this.resTypeLess = resTypeLess;
    }
    @ValueField(column = "resType" ,equal="<=") //小于条件
    public String getResTypeLess(){
        return this.resTypeLess;
    }
