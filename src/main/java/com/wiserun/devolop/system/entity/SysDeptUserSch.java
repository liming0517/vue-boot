...
创建人：代码生成器
Create date: **请补充**
功能说明：sys.deptuser SearchEntity查询用途类
修订信息(**请补充**)
修订日期:**请补充**
原因:**请补充**
修订人:**请补充**
...
public class SysDeptUserSch extends SearchEasyUI {
    ...
    private String deptIdSch; //等于条件
        private String deptIdLike; //模糊 LIKE 条件 仅限字符型字段 nvarchar
        private String deptIdMore; //大于条件
    private String deptIdLess; //小于条件
    
    private String userIdSch; //等于条件
        private String userIdLike; //模糊 LIKE 条件 仅限字符型字段 nvarchar
        private String userIdMore; //大于条件
    private String userIdLess; //小于条件
    ...
    public String getStateLess(){
       ...
       //等于条件
    public void setDeptIdSch(String deptIdSch){
        this.deptIdSch = deptIdSch;
    }
    @ValueField(column = "deptId") //等于条件
    public String getDeptIdSch(){
        return this.deptIdSch;
    }
    ...
    @LikeDoubleField(column = "deptId") //模糊条件-仅限字符型字段
    public String getDeptIdLike(){
    	    	    	        
        return this.deptIdLike;
    }
    
	    //大于条件
    public void setDeptIdMore(String deptIdMore){
        this.deptIdMore = deptIdMore;
    }
    @ValueField(column = "deptId" ,equal=">=") //大于条件
    public String getDeptIdMore(){
        return this.deptIdMore;
    }

	    //小于条件
    public void setDeptIdLess(String deptIdLess){
        this.deptIdLess = deptIdLess;
    }
    @ValueField(column = "deptId" ,equal="<=") //小于条件
    public String getDeptIdLess(){
        return this.deptIdLess;
    }

       //等于条件
    public void setUserIdSch(String userIdSch){
        this.userIdSch = userIdSch;
    }
    @ValueField(column = "userId") //等于条件
    public String getUserIdSch(){
    ...
    @LikeDoubleField(column = "userId") //模糊条件-仅限字符型字段
    public String getUserIdLike(){
	    ...
	    //大于条件
    public void setUserIdMore(String userIdMore){
        this.userIdMore = userIdMore;
    }
    @ValueField(column = "userId" ,equal=">=") //大于条件
    public String getUserIdMore(){
        return this.userIdMore;
    }

	    //小于条件
    public void setUserIdLess(String userIdLess){
        this.userIdLess = userIdLess;
    }
    @ValueField(column = "userId" ,equal="<=") //小于条件
    public String getUserIdLess(){
