...
创建人：代码生成器
Create date: **请补充**
功能说明：sys.basdeptinfo SearchEntity查询用途类
修订信息(**请补充**)
修订日期:**请补充**
原因:**请补充**
修订人:**请补充**
...
public class SysBasdeptinfoSch extends SearchEasyUI {
    ...
    private String basdeptCodeSch; //等于条件
        private String basdeptCodeLike; //模糊 LIKE 条件 仅限字符型字段 nvarchar
        private String basdeptCodeMore; //大于条件
    private String basdeptCodeLess; //小于条件
    
    private String basdeptNameSch; //等于条件
        private String basdeptNameLike; //模糊 LIKE 条件 仅限字符型字段 nvarchar
        private String basdeptNameMore; //大于条件
    private String basdeptNameLess; //小于条件
    
    private String basdeptTypeSch; //等于条件
        private String basdeptTypeLike; //模糊 LIKE 条件 仅限字符型字段 nvarchar
        private String basdeptTypeMore; //大于条件
    private String basdeptTypeLess; //小于条件
    ...
    public String getStateLess(){
       ...
       //等于条件
    public void setBasdeptCodeSch(String basdeptCodeSch){
        this.basdeptCodeSch = basdeptCodeSch;
    }
    @ValueField(column = "basdeptCode") //等于条件
    public String getBasdeptCodeSch(){
        return this.basdeptCodeSch;
    }

              //模糊条件-仅限字符型字段
    public void setBasdeptCodeLike(String basdeptCodeLike){
        this.basdeptCodeLike = basdeptCodeLike;
    }
    @LikeDoubleField(column = "basdeptCode") //模糊条件-仅限字符型字段
    public String getBasdeptCodeLike(){
    	    	    	        
        return this.basdeptCodeLike;
    }
    
	    //大于条件
    public void setBasdeptCodeMore(String basdeptCodeMore){
        this.basdeptCodeMore = basdeptCodeMore;
    }
    @ValueField(column = "basdeptCode" ,equal=">=") //大于条件
    public String getBasdeptCodeMore(){
        return this.basdeptCodeMore;
    }

	    //小于条件
    public void setBasdeptCodeLess(String basdeptCodeLess){
        this.basdeptCodeLess = basdeptCodeLess;
    }
    @ValueField(column = "basdeptCode" ,equal="<=") //小于条件
    public String getBasdeptCodeLess(){
        return this.basdeptCodeLess;
    }

       //等于条件
    public void setBasdeptNameSch(String basdeptNameSch){
        this.basdeptNameSch = basdeptNameSch;
    }
    @ValueField(column = "basdeptName") //等于条件
    public String getBasdeptNameSch(){
        return this.basdeptNameSch;
    }

              //模糊条件-仅限字符型字段
    public void setBasdeptNameLike(String basdeptNameLike){
        this.basdeptNameLike = basdeptNameLike;
    }
    @LikeDoubleField(column = "basdeptName") //模糊条件-仅限字符型字段
    public String getBasdeptNameLike(){
    	    	    	        
        return this.basdeptNameLike;
    }
    
	    //大于条件
    public void setBasdeptNameMore(String basdeptNameMore){
        this.basdeptNameMore = basdeptNameMore;
    }
    @ValueField(column = "basdeptName" ,equal=">=") //大于条件
    public String getBasdeptNameMore(){
        return this.basdeptNameMore;
    }

	    //小于条件
    public void setBasdeptNameLess(String basdeptNameLess){
        this.basdeptNameLess = basdeptNameLess;
    }
    @ValueField(column = "basdeptName" ,equal="<=") //小于条件
    public String getBasdeptNameLess(){
        return this.basdeptNameLess;
    }

       //等于条件
    public void setBasdeptTypeSch(String basdeptTypeSch){
        this.basdeptTypeSch = basdeptTypeSch;
    }
    @ValueField(column = "basdeptType") //等于条件
    public String getBasdeptTypeSch(){
        return this.basdeptTypeSch;
    }

              //模糊条件-仅限字符型字段
    public void setBasdeptTypeLike(String basdeptTypeLike){
        this.basdeptTypeLike = basdeptTypeLike;
    }
    @LikeDoubleField(column = "basdeptType") //模糊条件-仅限字符型字段
    public String getBasdeptTypeLike(){
    	    	    	        
        return this.basdeptTypeLike;
    }
    
	    //大于条件
    public void setBasdeptTypeMore(String basdeptTypeMore){
        this.basdeptTypeMore = basdeptTypeMore;
    }
    @ValueField(column = "basdeptType" ,equal=">=") //大于条件
    public String getBasdeptTypeMore(){
        return this.basdeptTypeMore;
    }

	    //小于条件
    public void setBasdeptTypeLess(String basdeptTypeLess){
        this.basdeptTypeLess = basdeptTypeLess;
    }
    @ValueField(column = "basdeptType" ,equal="<=") //小于条件
    public String getBasdeptTypeLess(){
        return this.basdeptTypeLess;
    }
