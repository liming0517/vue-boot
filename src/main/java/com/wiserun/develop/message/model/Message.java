...
public class Message {
	...
	//微信提醒人
	private String SM_WXNotified;
	//短信提醒人
	private String SM_DXNotified;
	//邮件提醒人
	private String SM_YJNotified;
	...
	public String getSM_WXNotified() {
		return SM_WXNotified;
	}
	public void setSM_WXNotified(String sM_WXNotified) {
		SM_WXNotified = sM_WXNotified;
	}
	public String getSM_DXNotified() {
		return SM_DXNotified;
	}
	public void setSM_DXNotified(String sM_DXNotified) {
		SM_DXNotified = sM_DXNotified;
	}
	public String getSM_YJNotified() {
		return SM_YJNotified;
	}
	public void setSM_YJNotified(String sM_YJNotified) {
		SM_YJNotified = sM_YJNotified;
	}
