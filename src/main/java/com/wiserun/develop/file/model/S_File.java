...
public class S_File {
		...
		public String toString() {
			return "S_File [SF_Code=" + SF_Code + ", SF_CreateTime=" + SF_CreateTime + ", SF_CreateUser="
					+ SF_CreateUser + ", SF_State=" + SF_State + ", SF_BussinessCode=" + SF_BussinessCode
					+ ", SF_FileType=" + SF_FileType + ", SF_FileName=" + SF_FileName + ", SF_Path=" + SF_Path
					+ ", SF_TempPath=" + SF_TempPath + "]";
		}
