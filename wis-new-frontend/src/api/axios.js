...
// 先判断环境，带端口的就默认访问本地
if (!!location.port) {
    Vue.prototype.HOST_PROXY_ADMIN = 'http://localhost:8080';
/*    Vue.prototype.HOST_PROXY_ADMIN = 'http://localhost:8080/RestFulAPI';//后端项目地址*/
    Vue.prototype.FONT_PROXY_PATH = 'http://localhost:9090';//前端项目地址
} else {
