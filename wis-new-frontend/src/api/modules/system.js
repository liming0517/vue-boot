...
const system = {
    ...
    menu: {
        ...
        modelList: config => createAPI('/resource/sonlist','post',config)
    },
    // 角色管理
    role: {
        ...
        listBytoken: config => createAPI('/role/listBytoken', 'post', config),
        all: config => createAPI('/role/all', 'post', config),
    },
    //资源权限行为
    action: {
    ...
    // 部门管理
    department: {
        list: config => createAPI('/department/list', 'post', config),
        save: config => createAPI('/department/save', 'post', config),
        delete: config => createAPI('/department/del', 'delete', config),
        listmenu: config => createAPI('/department/listmenu', 'post', config),
    },
	apply:{
