<template>
    <div class="components-container">
        <div class="filter-container">
            ...
            <el-button @click="createDialog(0)" type="gray"><i class="el-icon-plus"></i> 新增菜单</el-button>
        </div>
        ...
        <el-dialog :title="formTitle" :visible.sync="formVisible">
            <el-form class="small-space" :model="createdItem" label-position="left" label-width="70px" style='width: 60%; margin-left:0px;'>
                ...
                <el-form-item label="模块编号">
                    <el-input v-model="createdItem.resource_model" placeholder="请填写模块编号"></el-input>
                </el-form-item>
...
export default {
    ...
    methods: {
        ...
        commitForm() {
            ...
            this.createdItem.resource_name = this.createdItem.title;
