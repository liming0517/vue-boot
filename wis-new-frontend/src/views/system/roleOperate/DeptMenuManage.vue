<template>
    <el-dialog title="部门菜单管理" :visible.sync="menuVisible" v-loading.body="menuLoading" element-loading-text="玩命加载中">
        ...
        <div slot="footer" class="dialog-footer">
            ...
            <el-button type="warning" :loading="formMenuSubmiting" @click="commitMenuForm">确 定</el-button>
        </div>
    </el-dialog>
</template>
...
export default {
    ...
    methods: {
        getDeptMenu(id) {
            ...
            this.deptCode= id;
            this.$api.system.department.listmenu({
                data: {
        ...
        commitMenuForm() {
            ...
            this.$api.system.department.save({
                data: {
                    ...
                    resource_list: this.$refs.tree.getCheckedKeys(),
                }
            }).then(response => {
