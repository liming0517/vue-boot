<template>
    <el-table :data="tableData" v-loading.body="tableLoading" element-loading-text="拼命加载中" border fit highlight-current-row row-key="id">
        ...
        <el-table-column label="模块编号" prop="resource_model" align="center"></el-table-column>
        <el-table-column label="操作" align="center" width="320px">
            <template slot-scope="scope">
                ...
                <el-button size="small" @click="emitMenuUpdate(scope.row)" type="gray"><i class="el-icon-edit"></i></el-button>
